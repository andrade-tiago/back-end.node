...
export function testHashedPasswordParser(opt: TestOptions) {
  describe(`${opt.getInstanceFunc().constructor.name} - IHashedPasswordParser`, () => {
    ...
    describe('should trim spaces before validating', () => {
    ...
    describe('should throw error for non-bcrypt hashes or invalid strings', () => {
    ...
    describe('should throw error for hashes with incorrect length', () => {
    ...
    describe('should throw error for unsupported bcrypt version', () => {
